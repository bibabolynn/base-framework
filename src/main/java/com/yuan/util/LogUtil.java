...
public class LogUtil {
    ...
    public static Map<String, String> getNotErrorMap() {
        notErrorMap.put(PubErrorCode.PUB_IMG_COMPRESS, LogUtil.WARN); // 事例
        return notErrorMap;
    }

    @Around(value = "@annotation(logAnn)")
    public Object exceptionHander(ProceedingJoinPoint p, ExceptionAnnotation logAnn) throws BaseException {
        Object o = null;
        ...
        try {
            ...
            BaseException handerEx =
                    handerEx(p.getTarget().getClass().getSimpleName(), p.getSignature().getName(), errorCode, errorMsg, level, e);
            if (throw1) {
                throw handerEx;
            }
        }
    ...
    public static void error(Object msg, Throwable ex) {
        ...
        if (ex instanceof BaseException) {
            BaseException tfe = (BaseException) ex;
    ...
    public static void error(Throwable e, String errorCode, String errorMsg, boolean ifLog) throws BaseException {

        BaseException tfe = null;
        String errorCode_ = "";
        String errorMsg_ = "";
        if (e instanceof BaseException) {
            ...
            errorMsg_ = errorMsg;
            tfe = new BaseException(errorCode, errorMsg);
        }
    ...
    public static BaseException handerEx(String code, String msg) {

        return handerEx(code, msg, EMPTY, null);

    }

    public static BaseException handerEx(String code, String msg, Throwable e) {

        return handerEx(code, msg, EMPTY, e);

    }

    public static BaseException handerEx(String code, String msg, String level) {

        return handerEx(code, msg, level, null);

    }

    public static BaseException handerEx(String code, String msg, String level, Throwable e) {

        return handerEx(getLogClass(), getLogMethod(), code, msg, level, e);

    }

    public static BaseException handerEx(String code, String msg, String level, Map<String, Object> codeMap, Throwable e) {
     ...
     * @return
     */
    public static BaseException handerEx(String name, String method, String code, String msg, String level, Throwable e) {

        return handerEx(name, method, code, msg, level, null, LogUtil.getNotErrorMap(), e);
    }

    private static void printLog(String name, String level, String log_, BaseException tfe) {
     ...
     * @return
     */
    public static BaseException handerEx(String name, String method, String code, String msg, String level, Map<String, Object> codeMap,
            Map<String, String> notErrorMap, Throwable e) {
        ...
        BaseException tfe = handerExVo.getTfe();
        /*
    ...
    private static class HanderExVo {
        ...
        public HanderExVo invoke() {
            ...
            if (e == null) {
                errorCode_ = code;
                errorMsg_ = msg;
                tfe = new BaseException(errorCode_, errorMsg_);
                ...
                tfe = new BaseException(errorCode_, errorMsg_, e);
            }
